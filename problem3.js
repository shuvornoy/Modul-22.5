...
function paperRequirements(mathBook, englishBook, banglaBook) {
    let firstBookPage = 100 * mathBook;
    let secBookPage = 200 * englishBook;
    let thirdBookPage = 300 * banglaBook;
    let totalPage = firstBookPage + secBookPage + thirdBookPage;
    return totalPage;
}
let firstBook = 1;
let secBook = 1;
let thirdBook = 1;
var result = paperRequirements(firstBook, secBook, thirdBook);
